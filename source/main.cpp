...
void init_window() {
	...
	if (avformat_open_input(&app_window->format_ctx, "../resources/videos/rose.mp4", nullptr, nullptr) < 0) {
		abort();
	}
	...
	av_dump_format(app_window->format_ctx, -1, "../resources/videos/rose.mp4", 0);
